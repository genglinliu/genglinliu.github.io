...
Research Interests
-----
I'm broadly interested in Large Language Models and agentic systems powered by them. More specifically, I work on agent safety, self-improving models, and memory mechanisms of LLM agents.
...
- WebCoach: Improve Browsing Agents with Memory-Aware Guidance for Better Web Navigation \
  **Genglin Liu**, Shijie Geng, Sha Li, Hejie Cui, Sarah Zhang, Xin Liu, Tianyi Liu \
  ICLR 2026 MemAgent Workshop [[paper](https://arxiv.org/abs/2511.12997)]
...
------
**Spring 2026 - Summer 2026**: Google
 - Student Researcher
 - Hosts: Andy Zhang, Shalini Ghosh

**Fall 2025**: Google Research
 - Student Researcher
 - Hosts: Krishna Viswanathan, Ariel Fuxman
...
------
 - **Teaching Assistant** \
   CS 263: Natural Language Processing, winter 2026 \
